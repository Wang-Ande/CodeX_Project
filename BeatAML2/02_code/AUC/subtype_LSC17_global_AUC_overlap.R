...
# AUC correlations are not stratified by subtype.
# Outputs are written to 03_result/LSC17_AUC/subtype_lsc17_global_auc_overlap.
...
input_global_auc_cor <- file.path(project_root, "03_result", "LSC17_AUC", "drug_gene_auc_spearman_min100_all.csv")
input_global_auc_counts <- file.path(project_root, "03_result", "LSC17_AUC", "drug_gene_auc_expression_overlap_sample_counts.csv")
output_dir <- file.path(project_root, "03_result", "LSC17_AUC", "subtype_lsc17_global_auc_overlap")
...
input_summary <- data.frame(
  ...
  value = c(
    "Subtype-specific LSC17 association combined with global, non-subtype-stratified AUC association.",
    "Global AUC correlations from drug_gene_auc_spearman_min100_all.csv; not stratified by subtype.",
