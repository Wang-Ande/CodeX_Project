...
if (is.na(script_file) || !nzchar(script_file)) {
  script_file <- file.path(getwd(), "02_code", "Plasma_Protein", "sankey_reference_palette.R")
}
...
out_dir <- file.path(repo_dir, "03_result", "Plasma_Protein", "Sankey_reference_palette")
dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

cat("Sankey reference-palette pipeline\n")
...
palette_variants <- list(
  list(
    id = "01_cell_fraction_reference",
    name = "Cell fraction reference",
    note = "Reference-inspired palette using dark navy, mist blue, teal, muted wine, and pale lavender.",
    abundance = c("Q4" = "#1E4267", "Q3" = "#789DB6", "Q2" = "#73B8AE", "Q1" = "#BFA8D8", "Not detected" = "#7A2E4D"),
    organs = c(
      "Nervous / sensory" = "#D9CDEB",
      "Endocrine" = "#B47C72",
      "Immune / hematopoietic" = "#6FA59C",
      "Respiratory" = "#9AB8C9",
      "Digestive / metabolic" = "#2E6B66",
      "Urogenital / reproductive" = "#8A4E78",
      "Muscle / connective" = "#DFA4A5",
      "Epithelial / skin" = "#E2C8B8"
    )
  )
)
