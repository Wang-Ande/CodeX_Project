...
$OutDir = Join-Path $RepoDir "03_result\Plasma_Protein\Sankey_reference_palette_organ_colors"
$Report = Join-Path $OutDir "report.txt"
$Rscript = "D:\R\R-4.5.1\bin\x64\Rscript.exe"
$Pipeline = Join-Path $ScriptDir "sankey_reference_palette_organ_colors.R"
