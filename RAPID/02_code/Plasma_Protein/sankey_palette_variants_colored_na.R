...
if (is.na(script_file) || !nzchar(script_file)) {
  script_file <- file.path(getwd(), "02_code", "Plasma_Protein", "sankey_palette_variants_colored_na.R")
}
...
out_dir <- file.path(repo_dir, "03_result", "Plasma_Protein", "Sankey_palette_variants_colored_NA")
dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

cat("Sankey palette variants colored-NA pipeline\n")
...
palette_variants <- list(
  list(
    id = "01_sapphire_amber_na",
    name = "Sapphire amber NA",
    note = "Blue abundance ramp with amber NA for a warm, visible undetected component.",
    abundance = c("Q4" = "#17324D", "Q3" = "#2F6F9F", "Q2" = "#8EC3D9", "Q1" = "#D5E8EF", "Not detected" = "#E9A23B"),
    organs = c(
  ...
  list(
    id = "02_royal_mint_na",
    name = "Royal mint NA",
    note = "Purple-to-rose abundance ramp with mint NA to separate undetected proteins from the Q scale.",
    abundance = c("Q4" = "#2D1E59", "Q3" = "#7B2CBF", "Q2" = "#D1495B", "Q1" = "#F4A261", "Not detected" = "#62B6A4"),
    organs = c(
  ...
  list(
    id = "03_viridis_coral_na",
    name = "Viridis coral NA",
    note = "Viridis-like Q scale with coral NA for a vivid but distinct undetected category.",
    abundance = c("Q4" = "#440154", "Q3" = "#31688E", "Q2" = "#35B779", "Q1" = "#FDE725", "Not detected" = "#F97352"),
    organs = c(
  ...
  list(
    id = "04_teal_lilac_na",
    name = "Teal lilac NA",
    note = "Teal-to-cream abundance scale with lilac NA for a softer non-grey alternative.",
    abundance = c("Q4" = "#003049", "Q3" = "#0A9396", "Q2" = "#94D2BD", "Q1" = "#E9D8A6", "Not detected" = "#B565A7"),
    organs = c(
  ...
  list(
    id = "05_ink_gold_na",
    name = "Ink gold NA",
    note = "Deep ink and aqua abundance colors with gold NA for strong article-scale contrast.",
    abundance = c("Q4" = "#0B132B", "Q3" = "#3A506B", "Q2" = "#5BC0BE", "Q1" = "#F2D7EE", "Not detected" = "#FFB000"),
    organs = c(
