...
$OutDir = Join-Path $RepoDir "03_result\Plasma_Protein\Sankey_reference_palette_organ_flow_colors"
$Report = Join-Path $OutDir "report.txt"
$Rscript = "D:\R\R-4.5.1\bin\x64\Rscript.exe"
$Pipeline = Join-Path $ScriptDir "sankey_reference_palette_organ_flow_colors.R"

New-Item -ItemType Directory -Force -Path $OutDir | Out-Null

"===== Pipeline run started: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') =====" | Tee-Object -FilePath $Report
