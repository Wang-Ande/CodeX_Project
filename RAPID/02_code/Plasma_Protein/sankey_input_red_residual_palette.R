...
if (is.na(script_file) || !nzchar(script_file)) {
  script_file <- file.path(getwd(), "02_code", "Plasma_Protein", "sankey_input_red_residual_palette.R")
}
...
out_dir <- file.path(repo_dir, "03_result", "Plasma_Protein", "Sankey_input_red_residual_palette")
dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

cat("Sankey input-red-residual palette pipeline\n")
...
palette_variants <- list(
  list(
    id = "01_input_red_residual_organ_flow",
    name = "Input colors with red abundance and residual NA",
    note = "Organ colors extend the left input orange/cyan/blue style; Q categories use a red gradient; NA uses residual grey.",
    abundance = c("Q4" = "#9B4D58", "Q3" = "#C75A5D", "Q2" = "#F0786E", "Q1" = "#F7C6BB", "Not detected" = "#E6E6E6"),
    organs = c(
      "Brain" = "#EDA66E",
      "Cerebellum" = "#93CEDA",
      "Neuronal" = "#5678B8",
